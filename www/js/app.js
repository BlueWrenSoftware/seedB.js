...
class Controller {
 ...
 async requestLabelsQueue() {
  ...
  labelContent.innerHTML += `<div class="packet-labels-page__block_left par" >
        <p class="par__text_label-barcode">*${this.packetId}*</p>
        <p class="par__text_label-code">${this.packetId}</p>
...
//=> interim code for barcode reader on main page
//=> fix to be compliant with 
function enterBarcode() {
 document.querySelector('#scanBarcode').focus();
}